<template>
  ...
  >
    <div :class="`${id} grid --cllg-${cllgFx}`">
      <div class="grid-wrap" v-if="cllgFx.includes('1')">
        <div
          class="grid__item"
          v-for="index in 24"
      ...
      <div class="grid-wrap" v-if="cllgFx.includes('2')">
        <div class="grid-wrap__gallery grid-wrap__gallery--grid10" :class="id">
          <div
            v-for="index in 16"
            :key="`${id}-grid-item-${index}`"
