<template>
  <transition name="fade" mode="out-in">
    <div class="highlight-carousel" v-show="active">
      <figure
  ...
  <transition name="fade" mode="out-in">
    <div class="highlight-carousel__buttons" v-show="active">
      <svg
      ...
      <close-button :close-cb="() => emits('onCloseCarousel')" />
    </div>
  </transition>
</template>
...
const emits = defineEmits(["onCloseCarousel"]);

const imageIndex = ref<number>(props.activeImageIndex);
